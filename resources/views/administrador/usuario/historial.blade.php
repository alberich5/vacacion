	...
	<div class="modal-dialog">
		<div class="modal-content">
          ...
          <div class="row" v-for="usuario in users" v-if="usuario.id_elemento==idElemento" >
            ...
            <h5 id="modalEditar">@{{"Nombre: "+usuario.nombre +" "+ usuario.apellido_paterno+" "+ usuario.apellido_materno}}</h5>
      ...
      <div class="modal-body" id="colorTabla">
      <div class="row">
        <div class="col-sm-10 col-sm-offset-1">
          <table id="tablaAcciones" class=" table-hover" cellspacing="0" width="100%" border="1">
